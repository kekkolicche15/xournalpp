...
void Control::toolChanged() {
    ...
    this->actionDB->enableAction(Action::TOOL_DRAW_AGGREGATION_ARROW,
                                 toolHandler->hasCapability(TOOL_CAP_AGGREGATION_ARROW));
    this->actionDB->enableAction(Action::TOOL_DRAW_COMPOSITION_ARROW,
                                 toolHandler->hasCapability(TOOL_CAP_COMPOSITION_ARROW));
    this->actionDB->enableAction(Action::TOOL_DRAW_INHERITANCE_ARROW,
                                 toolHandler->hasCapability(TOOL_CAP_INHERITANCE_ARROW));
    ...
    this->actionDB->setActionState(Action::TOOL_DRAW_AGGREGATION_ARROW, dt == DRAWING_TYPE_AGGREGATION_ARROW);
    this->actionDB->setActionState(Action::TOOL_DRAW_COMPOSITION_ARROW, dt == DRAWING_TYPE_COMPOSITION_ARROW);
    this->actionDB->setActionState(Action::TOOL_DRAW_INHERITANCE_ARROW, dt == DRAWING_TYPE_INHERITANCE_ARROW);
