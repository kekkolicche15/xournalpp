...
static const std::map<std::string_view, Action> BOOLEAN_ACTION_MAP = {
        ...
        {"ACTION_TOOL_DRAW_AGGREGATION_ARROW"sv, Action::TOOL_DRAW_AGGREGATION_ARROW},
        {"ACTION_TOOL_DRAW_COMPOSITION_ARROW"sv, Action::TOOL_DRAW_COMPOSITION_ARROW},
        {"ACTION_TOOL_DRAW_INHERITANCE_ARROW"sv, Action::TOOL_DRAW_INHERITANCE_ARROW},
